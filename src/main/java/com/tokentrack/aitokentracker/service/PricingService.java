...
public class PricingService {
    ...
    private static final Map<String, double[]> PRICING = Map.ofEntries(
            Map.entry("openai/gpt-oss-20b", new double[]{0.075, 0.30}),
            Map.entry("openai/gpt-oss-safeguard-20b", new double[]{0.075, 0.30}),
            Map.entry("openai/gpt-oss-120b", new double[]{0.15, 0.60}),
            Map.entry("qwen/qwen3.6-27b", new double[]{0.60, 3.00})
    );
